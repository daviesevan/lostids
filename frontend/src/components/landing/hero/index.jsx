        ...
        <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div className="text-center">
              ...
              Find Your Lost National ID Effortlessly
              </p>
              <h1 className="scroll-m-20 text-4xl font-medium tracking-tight lg:text-5xl">
              Connecting you with those who’ve found lost ID. Search, verify, and reclaim your identity with ease.
              </h1>
            </div>
            {/* End Title */}
            {/* Avatar Group */}
                ...
                <div className="relative z-10 flex space-x-3 p-3 border bg-background rounded-lg shadow-lg">
                  <div className="flex-[1_0_0%]">
                    ...
                    <Input
                      ...
                      className="h-full"
                      id="search_ids"
                      placeholder="Search for your lost ID..."
                    />
                  </div>
